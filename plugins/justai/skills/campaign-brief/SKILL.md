...
- **Which channel per touchpoint?** (email, push, SMS, in-app, or mixed). Supported channels in the current runtime: **email**, **mobile push**, and **SMS** via Iterable or Customer.io, plus **transactional in-app** via Customer.io. Web push is not supported.
